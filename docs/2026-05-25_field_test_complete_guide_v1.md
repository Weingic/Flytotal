...
> [!WARNING]
> **本指南已于 2026-07-13 停用，不再作为可执行现场流程。** 其中的旧串口、摄像头、跟踪器和距离命令可能与当前 V4b/COM4 单一入口冲突。唯一权威采集流程是 [`2026-06-08_real_data_collection_sop_v1.md`](2026-06-08_real_data_collection_sop_v1.md)，请勿从本文复制命令执行。
