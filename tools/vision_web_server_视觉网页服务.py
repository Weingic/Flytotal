...
def build_node_brief_payload(
    ...
    return {
        ...
        "cloud_command_type": str(status_payload.get("cloud_command_type", "NONE") or "NONE"),
        "cloud_command_effect": str(status_payload.get("cloud_command_effect", "NONE") or "NONE"),
        "cloud_command_applied": safe_int(status_payload.get("cloud_command_applied", 0)),
